                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">iletisimler Tablosu</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <?php
                                                $iletisimsor = $db->prepare("SELECT * FROM iletisim ORDER BY iletisim_zaman DESC");
                                                $iletisimsor->execute();
                                                foreach($iletisimsor as $iletisimcek){
                                            ?>
                                            ...
                                            <td><?php echo $iletisimcek['iletisim_icerik'] ?></td>
                                            ...
                                            <td>
                                                <form action="../adming/islem.php" method="POST">
                                                    ...
                                                    <button class="btn btn-warning btn-sm" name="iletisimsil"><i class="fa fa-trash"></i> Sil</button>
                                                </form>
                                            </td>
                                        </tr>
                                        <?php } ?>
